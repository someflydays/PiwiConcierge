...
`working-notes` is what I was thinking while building it. `design-document.pdf` is the plan I wrote that November: recommendations, voice, backend, and how to keep the whole thing private and non-addictive (on-device inference, opt-in data, no endless scroll).

To run it, open the Xcode project, pick the Apple Vision Pro simulator, and hit run. Needs the visionOS SDK.
